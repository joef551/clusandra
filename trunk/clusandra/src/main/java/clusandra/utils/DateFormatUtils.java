 ...
 * $Revision: 48 $
 * $Author: jose $
 * $Id: DateFormatUtils.java 48 2011-06-27 20:14:32Z jose $
 */
 ...
 * @since 2.0
 * @version $Id: DateFormatUtils.java 48 2011-06-27 20:14:32Z jose $
 */
public class DateFormatUtils {
    ...
    public static void main(String args[]){
        ...
        System.out.println("timedate = " + DateFormatUtils.format(mills,
                FastDateFormat.getInstance().getPattern()));
        System.out.println("timedate = " + DateFormatUtils.format(mills,
                DateFormatUtils.ISO_DATE_FORMAT.getPattern()) + " " +
                DateFormatUtils.format(mills,
